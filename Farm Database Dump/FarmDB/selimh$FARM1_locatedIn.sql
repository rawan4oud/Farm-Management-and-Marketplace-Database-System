...
CREATE TABLE `locatedIn` (
  ...
  PRIMARY KEY (`fieldID`,`livestockID`,`duration`),
  KEY `livestockID` (`livestockID`),
  CONSTRAINT `locatedIn_ibfk_1` FOREIGN KEY (`fieldID`) REFERENCES `farmField` (`fieldID`),
  CONSTRAINT `locatedIn_ibfk_2` FOREIGN KEY (`livestockID`) REFERENCES `livestock` (`livestockID`)
...
-- Dump completed on 2021-12-15  5:35:13
