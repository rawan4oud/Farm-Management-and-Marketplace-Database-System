...
CREATE TABLE `oversees` (
  ...
  PRIMARY KEY (`staffID`,`livestockID`),
  KEY `livestockID` (`livestockID`),
  CONSTRAINT `oversees_ibfk_1` FOREIGN KEY (`staffID`) REFERENCES `staff` (`staffID`),
  CONSTRAINT `oversees_ibfk_2` FOREIGN KEY (`livestockID`) REFERENCES `livestock` (`livestockID`)
...
-- Dump completed on 2021-12-15  5:35:33
